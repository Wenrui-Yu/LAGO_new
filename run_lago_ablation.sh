#!/bin/bash
#SBATCH --gres=gpu:a40
#SBATCH --job-name=lago_mt5
#SBATCH --output=log/lago_mt5_%j.out
#SBATCH --error=log/lago_mt5_%j.err
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/lago_ablation}"
