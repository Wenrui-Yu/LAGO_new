#!/bin/bash
#SBATCH --gres=gpu:a40
#SBATCH --job-name=mt5_decoder
#SBATCH --output=log/mt5_decoder_%j.out
#SBATCH --error=log/mt5_decoder_%j.err
...
TRAIN_DATASETS="${TRAIN_DATASETS:-yywwrr/mmarco_english_500k}"
...
echo "Training mT5-based attack decoder"
echo "model=${MODEL_NAME}"
echo "train_datasets=${TRAIN_DATASETS}"
echo "train_samples=${TRAIN_SAMPLES}, batch_size=${BATCH_SIZE}, epochs=${NUM_EPOCHS}"
